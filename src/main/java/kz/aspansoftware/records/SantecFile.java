...
@Serdeable
public record SantecFile(Long id, Long container, String containerClass, String uuid, String filename, String filepath, LocalDateTime created, LocalDateTime modified, Boolean isRemoved) {
